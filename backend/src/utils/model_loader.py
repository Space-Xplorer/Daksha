...
class ModelLoader:
    ...
    def __new__(cls, models_dir: str = "src/models/innovathon"):
    ...
    def __init__(self, models_dir: str = "src/models/innovathon"):
        """
...
def get_model_loader(models_dir: str = "src/models/innovathon") -> ModelLoader:
    """
