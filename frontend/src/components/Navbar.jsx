...
const Navbar = () => {
  ...
  // Determine if we are inside the Quest (KYC, Config, Upload, etc.)
      ...
      <div className="flex items-center gap-8">
        {!isQuestActive ? (
          <>
            <button 
              onClick={() => setView('how')} 
              className={`flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ${view === 'how-it-works' ? 'text-[#4B0082]' : 'text-slate-400 hover:text-[#4B0082]'}`}
            >
            ...
            <button 
              ...
              className={`flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ${view === 'about' ? 'text-[#4B0082]' : 'text-slate-400 hover:text-[#4B0082]'}`}
            >
              <Info size={14} /> About
            </button>
            ...
            <button 
              ...
              className={`flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ${view === 'partner' ? 'text-[#4B0082]' : 'text-slate-400 hover:text-[#4B0082]'}`}
            >
