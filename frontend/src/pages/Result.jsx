...
const Result = () => {
  const { setView, service } = useShield();

  return (
    <div className="max-w-4xl mx-auto py-10 px-6 animate-in zoom-in-95">
      <div className="glass-card rounded-[4rem] p-16 border-b-[24px] border-[#F4C2C2]">
        ...
        <div className="text-center mb-12">
          <h2 className="text-9xl font-black text-[#4B0082] tracking-tighter italic mb-2 uppercase">Approved</h2>
          ...
          <div className="space-y-6">
            <div className="p-8 bg-white/80 rounded-[3rem] border border-white">
              ...
              <p className="text-sm text-slate-500 font-medium leading-relaxed italic">
                "Based on EBM shape functions, increasing your monthly savings by 5% will lower your premium by ₹1,200 next cycle."
              </p>
            </div>
            <div className="p-8 bg-[#4B0082] text-white rounded-[3rem] shadow-xl">
               <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Estimated Premium</p>
