  ...
  return (
    <div className="px-12 py-20 max-w-7xl mx-auto animate-in fade-in duration-1000">
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-center mb-40">
        <div>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#4B0082]/5 border border-[#4B0082]/10 text-[10px] font-black uppercase tracking-[0.2em] text-[#4B0082] mb-8">
            <Cpu size={14} className="text-[#4B0082]" fill="currentColor" /> Enterprise Nexus
          </div>
          <h2 className="text-7xl font-black text-[#4B0082] tracking-tighter leading-[0.9] mb-8">
          ...
          <div className="flex gap-4">
            <button className="brinjal-gradient text-[#4B0082] border-2 border-[#4B0082] px-10 py-5 rounded-full font-black uppercase tracking-widest text-xs shadow-2xl hover:scale-105 transition-all">
              Request API Access
            </button>
            <button className="px-10 py-5 rounded-full font-black uppercase tracking-widest text-xs border-2 border-slate-100 text-slate-400 hover:bg-slate-50 transition-all">
              View Docs
            </button>
          </div>
        </div>
        ...
        <div className="brinjal-gradient rounded-[4rem] p-12 text-white shadow-3xl relative overflow-hidden group isolate">
          {/* Background Blur Efx */}
          ...
          <h3 className="text-2xl font-black text-[#391e4f] mb-12 italic tracking-tight flex items-center gap-3 drop-shadow-sm">
            <BarChart3 className="text-[#391e4f]" /> Performance Benchmarks
          </h3>

          <div className="grid grid-cols-2 gap-6 mb-12">
            {/* Box 1: High Contrast Audit Reduction */}
            <div className="bg-[#2a004a]/60 p-8 rounded-3xl border-2 border-[#4B0082]/30 backdrop-blur-md shadow-lg hover:border-[#4B0082]/60 transition-all group/box">
              <p className="text-[10px] font-bold text-pink-200/80 uppercase tracking-widest mb-2">Audit Reduction</p>
              <p className="text-5xl font-black italic text-[#4B0082] drop-shadow-[0_0_10px_rgba(244,194,194,0.4)] group-hover/box:scale-110 transition-transform">84%</p>
            </div>
            ...
            <div className="bg-[#2a004a]/60 p-8 rounded-3xl border-2 border-[#4B0082]/30 backdrop-blur-md shadow-lg hover:border-[#4B0082]/60 transition-all group/box">
              ...
              <p className="text-5xl font-black italic text-white drop-shadow-sm group-hover/box:scale-110 transition-transform">~1.2s</p>
            </div>
          </div>

          {/* Bottom Progress Bar Container */}
          <div className="space-y-4 p-6 bg-[#2a004a]/40 rounded-3xl border border-[#4B0082]/20">
      ...
      <div className="mb-40">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {useCases.map((uc, i) => (
            <GlassCard key={i} className="p-10 hover:border-[#4B0082]/20 transition-all group">
              <div className="w-16 h-16 bg-[#4B0082]/5 rounded-2xl flex items-center justify-center text-[#4B0082] mb-8 group-hover:bg-[#4B0082] group-hover:text-[#4B0082] transition-all duration-500">
                {uc.icon}
              </div>
              <h5 className="text-xl font-black text-[#4B0082] mb-4 uppercase italic">{uc.title}</h5>
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-center mb-40">
        <div className="order-2 lg:order-1">
          <div className="bg-[#1a1a1a] rounded-[3rem] p-10 shadow-2xl relative border-t-8 border-[#4B0082]">
...
// Output: "Salary stability verified in P3..."
        ...
        <div className="order-1 lg:order-2">
          <h3 className="text-4xl font-black text-[#4B0082] italic tracking-tighter mb-8 underline decoration-[#4B0082] underline-offset-8">Developer-First Integration</h3>
      ...
      {/* --- TRUST & COMPLIANCE --- */}
      <GlassCard className="p-16 text-center border-b-[20px] border-[#4B0082]">
         <div className="w-20 h-20 bg-[#4B0082] rounded-full flex items-center justify-center mx-auto mb-10 text-[#4B0082] shadow-xl">
            <Lock size={32} />
         </div>
         <h3 className="text-4xl font-black text-[#4B0082] italic tracking-tighter mb-6">Enterprise-Grade Security</h3>
