  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-6 animate-in slide-in-from-bottom-10">
      <div className="text-center mb-16">
        <h2 className="text-5xl font-black text-[#4B0082] tracking-tighter italic">Hi, {userData.name}!</h2>
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mt-2">Choose your protection shield</p>
      </div>

      <div className="grid md:grid-cols-2 gap-10">
        <div onClick={() => handleSelect('loan')} className="group glass-card p-12 rounded-[4rem] text-center cursor-pointer hover:border-[#4B0082] transition-all relative overflow-hidden">
          <div className="w-20 h-20 bg-[#F4C2C2] rounded-3xl flex items-center justify-center mx-auto mb-8 text-[#4B0082] group-hover:scale-110 transition shadow-sm"><Landmark size={40} /></div>
          <h3 className="text-2xl font-black text-[#4B0082] mb-4">Loan Shield</h3>
          <p className="text-slate-400 text-sm font-medium mb-8">Verify credit health and cash-flow roadmaps.</p>
